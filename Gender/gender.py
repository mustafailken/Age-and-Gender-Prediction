...
classifier.save("C://Users/Mustafa/Desktop/Age-Prediction/Gender/yeniModel.h5py")
...
img= image.load_img("13111_1914-11-08_1976.jpg",target_size = (64,64))
img= image.img_to_array(img)
round(classifier.predict(img[None,:,:,:])[0][0])
